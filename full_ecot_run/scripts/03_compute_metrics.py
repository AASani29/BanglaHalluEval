...
JUDGE_FILES = {
    "tigerllm_9b": {
        "qa":           {"baseline_gt":    "tigerllm_qa_1000_ground_truth_eval_results.csv",
                         "baseline_hallu": "tigerllm_qa_4000_eval_results.csv",
                         "cot_gt":         "QA/Results/qa_cot_gt_tigerllm_9b.csv",
                         "cot_hallu":      "QA/Results/qa_cot_hallu_tigerllm_9b.csv"},
        "summarization":{"baseline_gt":    "tigerllm_summarization_1000_ground_truth_eval_results.csv",
                         "baseline_hallu": "tigerllm_summarization_3000_eval_results.csv",
                         "cot_gt":         "Summarization/Evaluation_Results/summ_1000_cot_tigerllm_9b.csv",
                         "cot_hallu":      "Summarization/Evaluation_Results/summ_3000_cot_tigerllm_9b.csv"},
        "reasoning":    {"baseline_gt":    "tigerllm_reasoning_1000_ground_truth_eval_results.csv",
                         "baseline_hallu": "tigerllm_reasoning_1000_eval_results.csv",
    ...
    "gpt4_1_mini": {
        ...
        "summarization":{"baseline_gt":    "Results/summarization_dataset_1000_eval_gpt_4_1_mini.csv",
                         "baseline_hallu": "Results/summarization_3000_eval_gpt_4_1_mini.csv",
                         "cot_gt":         "Summarization/Evaluation_Results/summ_1000_cot_gpt4_1_mini.csv",
                         "cot_hallu":      "Summarization/Evaluation_Results/summ_3000_cot_gpt4_1_mini.csv"},
        "reasoning":    {"baseline_gt":    "Results/reasoning_main_1000_eval_gpt_4_1_mini.csv",
                         "baseline_hallu": "Results/reasoning_1000_eval_gpt_4_1_mini.csv",
