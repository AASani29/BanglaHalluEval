#!/usr/bin/env python3
"""Label whether summarization outputs are hallucinated using a local/remote Ollama model.
...
Usage:
    python scripts/label_summarization_ollama.py \
        ...
        --output "Results/summarization_3000_labeled_qwen32b.csv" \
...
def main() -> None:
    ...
    p.add_argument("--model", default="qwen2.5:32b-instruct", help="Ollama model name")
    p.add_argument(
        "--ollama-url",
        default=None,
